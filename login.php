    ...
    <section class="main">
        <div class="container">
            ...
            <div class="main__form">
                            ...
                            <label class="input">
                                ...
                                <select name="role" id="Role">
                                    ...
                                    <optgroup label="Other Users">
                                        ...
                                        <option value="Principle Nursing Officer">Principle Nursing Officer</option>
                                        <option value="Nurse">Nurse</option>
                                        <option value="Accounting Officer">Accounting Officer</option>
                                        <option value="Procurement Office">Procurement Officer</option>
                ...
                <a href="reset_password.php" class="text-center text-white nav-link pt-3">Forgot Password</a>
